    ...
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <img src={parts} className="w-1/2 absolute right-0 top-1/2 border-white border-8 rounded-lg shadow-2xl" />
                </div>
                <div className='w-1/2 space-y-6 ml-8'>
                    ...
                    <button className="btn btn-primary border-0 bg-orange-600">Get More Info</button>
                </div>
            </div>
        </div>
    );
